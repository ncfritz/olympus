...
import type { HandbrakeProgress } from "./progress";

/** HandBrakeCLI options (as `--key=value`); HandbrakeCLIPath is the executable. */
export type HandbrakeOptions = {
...
class HandbrakeCommand extends EventEmitter {
  ...
  /** @param options HandBrakeCLI options; HandbrakeCLIPath is the executable */
  constructor(options: HandbrakeOptions = {}) {
    super();

    this.output = "";
    this.inProgress = false;
    this.options = options;
    this.HandbrakeCLIPath = options.HandbrakeCLIPath!;
  ...
  emitProgress(progress: HandbrakeProgress) {
    if (!this.inProgress) {
      this.emitBegin();
    }
