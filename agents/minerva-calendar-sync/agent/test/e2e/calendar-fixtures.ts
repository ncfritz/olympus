...
import { SYNCED_CALENDAR_STORE, SyncedCalendarStore } from "../../src/store/synced-calendar-store";
 ...
 */
export async function seedCalendar(app: INestApplication, calendar: SyncedCalendarConfig): Promise<void> {
