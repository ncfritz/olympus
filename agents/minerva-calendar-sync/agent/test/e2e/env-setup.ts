...
// against live Google/Microsoft credentials, DATABASE_URL points at a
// disposable temp SQLite file rather than the dev database, and
// GOOGLE_CREDENTIALS_DIR/MICROSOFT_CREDENTIALS_DIR point at empty temp dirs
// rather than the developer's real .credentials/.credentials-microsoft
