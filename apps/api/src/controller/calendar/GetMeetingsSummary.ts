...
import {
  GetMeetingSummaryStatisticsResponse,
  MeetingStatus,
...
export class GetMeetingsSummaryController {
  ...
  @ApiOperation({
    ...
    operationId: "GetMeetingsMonthSummaryController",
  })
  @ApiTags("Meetings")
  ...
  @ApiOkResponse({
    ...
    type: GetMeetingSummaryStatisticsResponse,
  })
  @ApiStandardErrorResponses()
  async handle(
    ...
    const responseBody: GetMeetingSummaryStatisticsResponse = {
