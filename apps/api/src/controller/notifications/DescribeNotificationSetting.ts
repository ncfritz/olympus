...
export class ListNotificationSettingsController {
  ...
  @Get("/v1/notifications/settings/:username/:notificationType/:channel")
  @ApiOperation({
    summary: "Retrieves a notification settings for a user",
    description: "Retrieves a single notification setting for a user.",
