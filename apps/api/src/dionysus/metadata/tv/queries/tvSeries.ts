...
} from "../../../media/favorites/queries/mediaFavorite";
import { SEARCH_CONFIGURATION } from "../../../media/searchConfigurations/queries/searchConfiguration";
import { CERTIFICATIONS } from "../../certifications/queries/certifications";
import {
  ALTERNATIVE_TITLES,
  BASE_LANGUAGE,
  COUNTRY_ASSOCIATION,
...
import { NETWORKS } from "../../networks/queries/networks";
